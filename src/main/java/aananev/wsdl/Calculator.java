...
@WebServiceClient(name = "Calculator", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://www.dneonline.com.asmx?WSDL")
public class Calculator extends Service {
    public static final URL CALCULATOR_WSDL_LOCATION;
    public static final WebServiceException CALCULATOR_EXCEPTION;
    public static final QName CALCULATOR_QNAME = new QName("http://tempuri.org/","Calculator");
    static {
        URL url = null;
